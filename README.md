...
<br/> Measurements V3.x taken with a NVIDIA GeForce GTX 5060 Ti (Palit Infinity 3)

Range | Count | V2.1 | V2.2 | V2.3 | V3.0 | V3.1
----- | ----- | ----------- | -------- | -------- | -------- | --------
0 … 10^11	| 4.118.054.813	| 0,60s | 0,577s | 0,564s      | 0,225s   | 0,195s
0 … 10^12	| 37.607.912.018	| 8,31s | 7,32s | 5,91s      | 2,993s    | 2,643s
0 … 10^13	| 346.065.536.839	| 103s | 87,2s |75,9s    | 36,2s        | 33,1s
0 … 10^14	| 3.204.941.750.802	|  1231s| 1019s | 952s   | 439s       | 408s
10^12 + 10^11	| 3.612.791.400	| 0,90s | 0,795s | 0,707s   | 0,303s  | 0,293s
10^13 + 10^11	| 3.340.141.707	| 1,08s | 0,919s | 0,815s    | 0,376s | 0,357s
10^14 + 10^11	| 3.102.063.927	| 1,26s | 1,057s | 1,002s   | 0,469s  | 0,439s
10^15 + 10^11	| 2.895.317.534	| 1,44s | 1,235s | 1,186s    | 0,553s | 0,522s
10^16 + 10^11	| 2.714.336.584	| 1,62s | 1,494s | 1,365s   | 0,642s  | 0,610s
10^17 + 10^11	| 2.554.712.095	| 1,81s | 1,664s | 1,548s   | 0,732s  | 0,702s
10^18 + 10^11	| 2.412.731.214	| 2,08s | 1,912s | 1,790s   | 0,827s  | 0,794s
4x10^18 + 10^11	| 2.334.654.194	| 2,34s | 2,166s  | 2,056s| 0,895s  | 0,865s
10^19 + 10^11	| 2.285.693.139	| 2,64s | 2,518s | 2,326s   | 0,989s  | 0,942s
1,4x10^19 + 10^11	| 2.268.304.926	| 2,81s | 2,646s | 2,461s| 1,032s | 0,984s
1,8x10^19 + 10^11	| 2.255.482.326	| 2,91s | 2,747s | 2,586s| 1,073s | 1,027s
...
Sieve source code for V2.2 ... V3.1 is identical. Only program and CUDA parameter and tool sets were changed.
